...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/vynazevedo/openfire) and is the recommended method of installation.

```bash
docker pull vynazevedo/openfire:4.6.2
```

Alternatively you can build the image yourself.

```bash
docker build -t vynazevedo/openfire github.com/vynazevedo/docker-openfire
```
